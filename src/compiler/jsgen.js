...
class JSGenerator {
    ...
    descendStackedBlock (node) {
        ...
        switch (node.kind) {
        case 'your mom':
            const urmom = 'https://arkide.site/dump/urmom-your-mom.mp4';
            const yaTried = 'https://arkide.site/dump/chips.mp4';
            const MISTERBEAST = 'https://arkide.site/dump/MISTER_BEAST.webm';
